...
local function processStatFile(name, changeOutLocation)
	...
	local function processLine(line)
		...
		local parent = line:match('include "Metadata/Balance/StatDescriptions/(.+)%.csd"$')
		if parent then
	...
	local text = convertUTF16to8(getFile("Metadata/Balance/StatDescriptions/"..name..".csd"))
...
local handle = NewFileSearch("ggpk/Metadata/Balance/StatDescriptions/Specific_Skill_Stat_Descriptions/*.csd")
while handle do
...
local skillSpecificFolders = scandir(main.ggpk.oozPath.."Metadata/Balance/StatDescriptions/Specific_Skill_Stat_Descriptions")

for _, name in ipairs(skillSpecificFolders) do
	local handle = NewFileSearch("ggpk/Metadata/Balance/StatDescriptions/Specific_Skill_Stat_Descriptions/"..name.."/*.csd")
	while handle do
